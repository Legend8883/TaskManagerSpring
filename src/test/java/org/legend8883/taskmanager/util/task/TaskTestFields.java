...
public final class TaskTestFields {
    ...
    public static final LocalDateTime TASK_DATE_TIME_WHEN_YOU_NEED_TO_COMPLETE = LocalDateTime.now().plusDays(1);
    ...
    public static final LocalDateTime TASK_UPDATED_AT = LocalDateTime.now();
    ...
    public static final LocalDateTime DIFFERENT_TASK_DATE_TIME_WHEN_YOU_NEED_TO_COMPLETE = LocalDateTime.now().plusDays(2);
